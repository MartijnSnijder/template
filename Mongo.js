...
//         db.close();
//     });
// }  var insertOneLogFile = function (db, callback)
//
function insertProduct(db, item) {
    console.log("Wordt de MONGO troep hier aangeroepen ?");
    console.log(JSON.stringify(item));
    console.log(JSON.stringify(item.naam));

    var collection = db.collection('log');
    console.log('Leef ik nog ?');
    collection.insertOne({
        errorname: "MONGO HARD",
        date: new Date(),
...
/**
 ...
 var insertLogFiles = function(db, callback) {
 ...
 var updateLog = function(db, callback) {
    // Get the documents collection
    var collection = db.collection('log');
 ...
 var removeLog = function(db, callback) {
    // Get the documents collection
    var collection = db.collection('log');
